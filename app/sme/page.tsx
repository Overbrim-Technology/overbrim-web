...
function ForOrganizations() {
  return (
    <section id="organizations" className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:px-8 lg:py-28">
      <div><p className="font-nexa-heavy text-xs uppercase tracking-[0.28em] text-teal-700">01 / For Organizations</p><h2 className="mt-4 font-marcellus text-4xl leading-tight text-slate-950 sm:text-5xl">Human intelligence for better models.</h2><p className="mt-6 font-nexa-light leading-7 text-slate-600">AI systems become more useful when the data behind them is accurate, contextual, and carefully evaluated. Overbrim SME gives Organizations access to a global network of specialists and the operating discipline to turn their knowledge into dependable training data.</p><Link href="#contact" className="mt-8 inline-block font-nexa-heavy text-sm text-teal-700 hover:text-teal-900">Design your expert pipeline →</Link></div>
